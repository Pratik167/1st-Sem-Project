        	...
        	for (int q=0;q<3;q++) 
                    ...
                    system("cls");
						  ...
						  if(find==0)
						  {
							  ...
							  fclose(mp);
							  fclose(tp);
							  remove("P:\\invoice\\menu.txt");
							  rename("P:\\invoice\\tempmenu.txt","P:\\invoice\\menu.txt");
						...
						case(3):
							{
								...
								gets(cprice);
								tp=fopen("P:\\invoice\\menu.txt","a+");
		                        mp=fopen("P:\\invoice\\tempmenu.txt","a+");
								while(fread(&menu,sizeof(menu),1,tp)==1)
							    {
								...
								if(!find)
								{
				             	...
				             	else
				             	{
						           ...
						           printf("\nDo you wanna do it for more item,  if yes press y:\t");
    ...
    switch (opt) 
	{
        case 1:
        	...
        	for (int q=0;q<3;q++) 
                    ...
                    system("cls");
                    printf("\n\t\t\t\t\tSIGN UP");
                    printf("\n Please Type 'proceed' to Confirm:\t");
            input(user.role);

            if ((strcmp(user.role,"proceed")==0)||(strcmp(user.role,"Proceed")==0))
			{
                int admin_exists = 0;
